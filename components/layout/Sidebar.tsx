...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  admin: [
    ...
    { label: 'Landing Page',   href: '/admin/landing',         icon: <IconLayout /> },
...
function IconLayout() {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>
}
